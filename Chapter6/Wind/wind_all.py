...
if __name__ == '__main__':
    """
    ALL POSSIBLE ACTIONS, INCLUDE NO-ACTION
    """
    width = 10
    height = 7
    start = (0, 3)
    ...
    for i, method in enumerate(episode_length.keys()):
        ...
        plt.legend()
    plt.savefig("Episode_length_all.pdf", dpi=100, format='pdf')
    ...
    for method in state_action.keys():
        ...
        plt.savefig("{}_optimal_policy_all.pdf".format(method), dpi=100, format='pdf')
